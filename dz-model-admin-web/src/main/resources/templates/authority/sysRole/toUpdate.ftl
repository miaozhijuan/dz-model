...
<body>
	<div class="main-container">
		<form class="form-horizontal" method="post" id="inputFrom">
			<input type="hidden" name="id" value="${sysRole.id?default('')}" />
			<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
				<tr>
					<td>角色名称</td>
					<td>
						<input type="text" name="name" id="name" class="required col-xs-10 col-sm-5" value="${sysRole.name?default('')}" />
					</td>
				<tr>
			</table>
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					<button class="btn btn-info permission" type="button" onclick="submitForm()" permission="7cefbcff-a562-4225-a22d-e258e06ac0e3">
