		...
		<form class="form-horizontal" method="post" id="inputFrom">
			<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
				...
				<tr>
					...
					<td>
						<select name="level" id="level" class="required col-xs-10 col-sm-2">
							<option value="0">主权限</option>
							<option value="1">副权限</option>
						</select>
					</td>
				<tr>
				<tr>
					<td>路径</td>
					<td>
						<input type="text" name="url" id="url" class="required col-xs-10 col-sm-5" />
					</td>
				<tr>
				<tr>
					<td>排序</td>
					<td>
						<input type="text" name="sort" id="sort" class="required col-xs-10 col-sm-5" />
					</td>
				<tr>
				<tr>
					<td>是否启用</td>
				...
				<tr>
					<td>备注</td>
					<td>
						<input type="text" name="remark" id="remark" class="col-xs-10 col-sm-5" />
					</td>
				<tr>
			</table>
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					<button class="btn btn-info permission" type="button" onclick="submitForm()" permission="edc8237a-28ff-48c1-9573-449dfbd83b2e">
