		...
		<form class="form-horizontal" method="post" id="inputFrom">
			<table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
				...
				<tr>
					<td>密码</td>
					<td>
						<input type="password" name="pwd" id="pwd" class="required col-xs-10 col-sm-5" />
					</td>
				<tr>
				<tr>
					<td>用户名</td>
					<td>
						<input type="text" name="realName" id="realName" class="required col-xs-10 col-sm-5" />
					</td>
				<tr>
				<tr>
					<td>是否启用</td>
			...
			<div class="clearfix form-actions">
				<div class="col-md-offset-3 col-md-9">
					<button class="btn btn-info permission" type="button" onclick="submitForm()" permission="a9881455-41ed-4703-88f6-9fd6055eae3d">
